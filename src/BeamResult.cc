...
//			modelsDest, beamSize, transferOutFilePath, beamOutFilePath;
//
//	if (argc == 9) {
//		localeId = argv[1];
...
//				CLExec::loadYasmetModels(modelsDest, &localeId);
//
...
//				// beam tree
//				vector<pair<vector<Node>, float> > beamTree;
//				// rules combinations
...
//
//				getOuts(&outs, &combNodes, beamTree, nodesPool, ruleOutputs,
//						spaces);
//
//				// read transfer
//				string line;
