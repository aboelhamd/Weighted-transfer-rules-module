...
int main(int argc, char **argv) {
	string sentenceFilePath, lextorFilePath, localeId, transferFilePath,
			transferOutFilePath, weightFilePath, outputFilePath,
			bestModFilePath, randModFilePath;
...
//		bestModFile << "Source :  " << sourceSentence << endl << endl;
					...
					// final sentence
					bestModFile /*<< "Target :  "*/<< normTransfers[maxInd]
							<< endl;
					// score
...
//		randModFile << "Source :  " << sourceSentence << endl << endl;
					...
					// final sentence
					randModFile /*<< "Target :  "*/<< normTransfers[random]
							<< endl;
					// score
