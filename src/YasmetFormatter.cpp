...
//			weightOutFilePath = "weights.txt", localeId = "kk_KZ",
//			transferFilePath = "transferFile.tx1", datasetsPath = "datasets";
//
//	if (argc == 7) {
//		localeId = argv[1];
...
//
//		vector<string> *sourceSentences = new vector<string>(),
//				*tokenizedSentences = new vector<string>();
//
...
////      vector<vector<AmbigInfo> >* vambigInfo = new vector<
////	  vector<AmbigInfo> > ();
////      vector<vector<vector<Node> > > vcompNodes;
//
...
//
//				ruleOuts(&ruleOutputs, &tokenRules, slTokens, slTags, tlTokens,
...
//				vector<AmbigInfo> ambigInfo;
//				// rules combinations
//				vector<vector<Node> > combNodes;
//
//				nodesPool = getNodesPool(tokenRules);
//
//				getAmbigInfo(tokenRules, nodesPool, &ambigInfo, &compNum);
//
//				getOuts(&outs, &combNodes, ambigInfo, nodesPool, ruleOutputs,
//						spaces);
//
//				vector<AmbigInfo> newAmbigInfo;
...
//
//						string features;
//						for (unsigned v = 0; v < ambig.combinations.size();
//								v++) {
//							stringstream ss;
////			    ss.clear ();
//							ss << v;
