...
//
//void
//BeamSearch::transfer (string transferFilePath, string localeId, string modelsFileDest,
...
//      for (map<unsigned, vector<RuleExecution::Node*> >::iterator it = nodesPool.begin ();
//	  it != nodesPool.end (); it++)
//	{
...
//      "/home/aboelhamd/Downloads/newmodel2.model");
...
////	}
////	cout << endl;
//  for (map<string, map<string, vector<float> > >::iterator it = models.begin ();
//      it != models.end (); it++)
//    {
